...
@interface ArtistMyViewController ()
...
@implementation ArtistMyViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    
    MyArtworkViewController *myArtworkVC = [[MyArtworkViewController alloc] init];
    
    self.viewControllers = @[myArtworkVC,[self creatViewControllerPage:1 itemNum:16],[self creatViewControllerPage:2 itemNum:6],[self creatViewControllerPage:3 itemNum:12],[self creatViewControllerPage:0 itemNum:6]];
