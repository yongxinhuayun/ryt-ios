//
//  FansBasicTableViewController.m
//  融易投
//
...
#import "FansMyArtistTableViewController.h"
...
@interface FansMyArtistTableViewController ()<FansMyTableViewCellDelegate>
...
@implementation FansMyArtistTableViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:[UINib nibWithNibName:@"FansTableViewCell" bundle:nil] forCellReuseIdentifier:ID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FansTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID forIndexPath:indexPath];
