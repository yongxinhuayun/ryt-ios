...
@interface FansMyViewController () <UIScrollViewDelegate>
...
@implementation FansMyViewController
...
- (void)setUpChildVcs
{
    [self addChildViewController:[[FansMyArtistTableViewController alloc] init]];
    [self addChildViewController:[[FansMyUserTableViewController alloc] init]];
